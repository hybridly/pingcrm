...
return [
    ...
    "accepted_if" =>
        ":Otherが:valueの場合、:attributeを承認する必要があります。",
    ...
    "declined_if" =>
        ":Otherが:valueの場合、:attributeを拒否する必要があります。",
    ...
    "doesnt_end_with" =>
        ":Attributeは次のいずれかで終わってはいけません。: :values",
    "doesnt_start_with" =>
        ":Attributeは次のうちいずれかで始まってはいけません。: :values",
    "email" => ":Attributeは、有効なメールアドレス形式で指定してください。",
    "ends_with" =>
        ":Attributeは、次のうちのいずれかで終わらなければいけません。: :values",
    ...
    "lt" => [
        "array" =>
            ":Attributeの項目数は、:value個より少なくなければいけません。",
    ...
    "mimes" =>
        ":Attributeには、以下のファイルタイプを指定してください。:values",
    "mimetypes" =>
        ":Attributeには、以下のファイルタイプを指定してください。:values",
    "min" => [
    ...
    "password" => [
        ...
        "mixed" =>
            ":Attributeは大文字と小文字をそれぞれ1文字以上含める必要があります。",
        "numbers" => ":Attributeは数字を1文字以上含める必要があります。",
        "symbols" => ":Attributeは記号を1文字以上含める必要があります。",
        "uncompromised" =>
            ":Attributeは情報漏洩した可能性があります。他の:attributeを選択してください。",
    ],
    "present" => ":Attributeが存在している必要があります。",
    "prohibited" => ":Attributeの入力は禁止されています。",
    "prohibited_if" =>
        ":Otherが:valueの場合は、:Attributeの入力が禁止されています。",
    "prohibited_unless" =>
        ":Otherが:valuesでない限り、:Attributeの入力は禁止されています。",
    "prohibits" =>
        ":Otherが存在している場合、:Attributeの入力は禁止されています。",
    "regex" => ":Attributeには、正しい形式を指定してください。",
    "required" => ":Attributeは必須項目です。",
    "required_array_keys" =>
        ":Attributeには、:valuesのエントリを含める必要があります。",
    "required_if" => ":Otherが:valueの場合、:attributeを指定してください。",
    "required_if_accepted" =>
        ":Otherを承認した場合、:attributeは必須項目です。",
    "required_unless" =>
        ":Otherが:values以外の場合、:attributeは必須項目です。",
    "required_with" =>
        ":Valuesが入力されている場合、:attributeは必須項目です。",
    "required_with_all" =>
        ":Valuesが全て指定されている場合、:attributeは必須項目です。",
    "required_without" =>
        ":Valuesが入力されていない場合、:attributeは必須項目です。",
